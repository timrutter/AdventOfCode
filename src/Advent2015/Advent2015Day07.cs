...
public class Advent2015Day07 : Solution
{
    ...
    public override object ExecutePart1()
    {
        ...
        foreach (var match in lines)
            ...
            {
                instructions.Add((match.Item1.Groups[2].Value, match.Item1.Groups[1].Value, match.Item1.Groups[3].Value,
                    match.Item1.Groups[4].Value));
            }
            else
            {
            ...
            while (true)
            {
                for (var index = 0; index < instructions.Count; index++)
                {
                    ...
                    switch (line.operation)
                    {
                        ...
                        case "AND":
                        {
                            if ((!int.TryParse(line.in1, out var inNum) && !dict.Keys.Contains(line.in1)) ||
                                !dict.Keys.Contains(line.in2)) continue;
                            //Console.WriteLine($"{line.in1} {line.operation} {line.in2} -> {line.out1}");
