...
internal static class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        while (cons != "q")
        {
            ...
            Execute(new Advent2025.Advent2025(), GetDays(DayMode.Day,[10]));
    ...
    private static void WriteAnswer(object answer, object expected, int day, int part, Stopwatch sw,
        bool showIncomplete)
    {
        switch (answer)
        {
    ...
    private static void Execute(ISolutions solutions, List<int> days, bool showIncomplete = false)
    {
        ...
        foreach (var day in days)
        {
            ...
            var m = methods.FirstOrDefault(m => m.GetType().Name == $"{m.GetType().Name[..10]}Day{day:00}");
            if (m == null)
            {
