...
public class Advent2021Day07 : Solution
{
    ...
    public override object ExecutePart2()
    {
        ...
        foreach (var pos in Functions.Range(1, dictionary.Keys.Max()))
            posAccumulations.Add(posAccumulations.Last() + pos);
        return Functions.Range(0, dictionary.Keys.Max()).Min(targetPos =>
            dictionary.Keys.Sum(pos => posAccumulations[Math.Abs(pos - targetPos)] * dictionary[pos]));
    }
}